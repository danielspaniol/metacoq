...
then
    ...
    then
        ...
        ETAEXPAND_DEPS="-R ../safechecker/theories MetaCoq.SafeChecker"
    ...
    echo "# DO NOT EDIT THIS FILE: autogenerated from ./configure.sh" > eta-expansion/metacoq-config
    ...
    echo ${CHECKER_DEPS} ${SAFECHECKER_DEPS} ${ETAEXPAND_DEPS} >> eta-expansion/metacoq-config
